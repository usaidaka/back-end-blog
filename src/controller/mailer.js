...
<div style="font-family: Helvetica,Arial,sans-serif;min-width:1000px;overflow:auto;line-height:2">
  <div style="margin:50px auto;width:70%;padding:20px 0">
    ...
    <p>Use the following OTP to complete your Password Recovery Procedure. <span style="color:red">DO NOT LET PEOPLE KNOW YOUR OTP CODE !</span>. OTP and link will valid for 20 minutes</p>
...
<div style="font-family: Helvetica,Arial,sans-serif;min-width:1000px;overflow:auto;line-height:2">
  ...
  sendChangeEmailVerify({ recipient_email, link }) {
    return new Promise((resolve, reject) => {
      var transporter = nodemailer.createTransport({
        service: "gmail",
        auth: {
      ...
      const mail_configs = {
        from: process.env.MY_EMAIL,
        to: recipient_email,
        subject: "YOUR EMAIL CHANGED, VERIFY YOUR ACCOUNT AGAIN",
        html: `
<!DOCTYPE html>
<html lang="en" >
<head>
...
<div style="font-family: Helvetica,Arial,sans-serif;min-width:1000px;overflow:auto;line-height:2">
  <div style="margin:50px auto;width:70%;padding:20px 0">
    ...
    <p style="font-size:1.1em">Hi,</p>
    <p>your email has changed, verify your account again for the wide relation with another author!</p>
    <a href=${link} style="background: #02cc35;margin: 0 auto;width: max-content;padding: 5px 10px;color: #fff;border-radius: 4px;text-decoration:none;">verify your account</a>
    <p style="font-size:0.9em;">Regards,<br />JCWD PURWADHIKA JAKARTA</p>
    <hr style="border:none;border-top:1px solid #eee" />
    <div style="float:right;padding:8px 0;color:#aaa;font-size:0.8em;line-height:1;font-weight:300">
  ...
  resendVerifyAccount({ recipient_email, link }) {
    return new Promise((resolve, reject) => {
      var transporter = nodemailer.createTransport({
        service: "gmail",
        auth: {
